...
CSV_FILE = "kendama_collection.csv"
...
app_ui = ui.page_fluid(
    ...
    ui.h2("Kendama Collection Manager"),
    ...
    ui.layout_sidebar(
        ui.sidebar(
            ...
            ui.input_date("purchased_date", "Purchased Date", value=date.today(), format="yyyy-mm-dd"),
            ...
            ui.br(),
            ui.input_action_button("add", "Add to Collection", class_="btn-primary"),
            ui.br(), ui.br(),
        ...
        ui.input_action_button("delete", "Delete Selected Row", class_="btn-danger"), 
    )
)
...
def server(input, output, session):
    ...
    def table():
        ...
        rendered_df['purchased_date'] = rendered_df['purchased_date'].astype(str).str.replace(" 00:00:00", "")
    ...
    def download_csv():
        ...
        output_data['purchased_date'] = output_data['purchased_date'].astype(str).str.replace(" 00:00:00", "")
